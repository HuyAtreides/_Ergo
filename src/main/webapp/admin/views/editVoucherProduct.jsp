...
<html>
  ...
  <body>
    ...
    <div
      class="show"
      id="editVoucherProduct"
      tabindex="-1"
      aria-labelledby="editVoucherModal"
      aria-hidden="false"
    >
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="editProduct" method="post">
              <!-- Common Fields -->
              <div class="mb-3">
                <label for="editVoucherCodeProduct" class="form-label"
                  >Voucher Code</label
                >
                <input
                  type="text"
              ...
              <div class="mb-3">
                ...
                <input
                  ...
                  step="0.01"
                  value="${editVoucherDiscountProduct}"
                  required
                />
              </div>
              <div class="mb-3">
                ...
                <input
                  ...
                  value="${editVoucherDateStartProduct}"
                  required
                />
              </div>
              <div class="mb-3">
                ...
                <input
                  ...
                  value="${editVoucherDateEndProduct}"
                  required
                />
              </div>
              ...
              <div class="mb-3">
                ...
                >
                  <c:forEach var="productType" items="${productTypes}">
                    <option value="${productType.getTypeId()}">
                      ${productType.getProduct().getName()} | ${productType.getColor()}
                    </option>
                  </c:forEach>
                </select>
