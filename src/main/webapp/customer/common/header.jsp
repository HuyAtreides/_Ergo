			...
			<div
				...
				<div class="cart text-end d-none d-lg-block dropdown">
					<button
						...
						<span class="fs-6 text-muted dropdown-toggle">Your Cart</span> <span
							class="cart-total fs-5 fw-bold">$1290.00</span>
					</button>
				</div>
			</div>
					...
					<div class="offcanvas offcanvas-end" tabindex="-1"
						...
						<div class="offcanvas-body">
							...
							<ul
								...
								<li class="nav-item active"><a href="#women"
									class="nav-link">Women</a></li>
								<li class="nav-item dropdown"><a href="#men"
									class="nav-link">Men</a></li>
								<li class="nav-item"><a href="#kids" class="nav-link">Kids</a>
								</li>
								<li class="nav-item"><a href="#accessories"
									class="nav-link">Accessories</a></li>
								<li class="nav-item dropdown"><a
									class="nav-link dropdown-toggle" role="button" id="pages"
									data-bs-toggle="dropdown" aria-expanded="false">Pages</a>
									<ul class="dropdown-menu" aria-labelledby="pages">
										<li><a href="index.jsp" class="dropdown-item">About
												Us </a></li>
										<li><a href="index.jsp" class="dropdown-item">Shop </a></li>
										<li><a href="index.jsp" class="dropdown-item">Single
												Product </a></li>
										<li><a href="index.jsp" class="dropdown-item">Cart </a></li>
										<li><a href="index.jsp" class="dropdown-item">Checkout
										</a></li>
										<li><a href="index.jsp" class="dropdown-item">Blog </a></li>
										<li><a href="index.jsp" class="dropdown-item">Single
												Post </a></li>
										<li><a href="index.jsp" class="dropdown-item">Styles
										</a></li>
										<li><a href="index.jsp" class="dropdown-item">Contact
										</a></li>
										<li><a href="index.jsp" class="dropdown-item">Thank
												You </a></li>
										<li><a href="index.jsp" class="dropdown-item">My
												Account </a></li>
										<li><a href="index.jsp" class="dropdown-item">404
												Error </a></li>
									</ul></li>
								<li class="nav-item"><a href="#brand" class="nav-link">Brand</a>
								</li>
